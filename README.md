...
| Week 12 | Contributions done in Pattern-library |   [Scroll to Week 12](#week-12) |
...
---------------------------
 ## Repositories to contribute to
   ...
   I found some gopod projects from the [Goodfirstissue](https://goodfirstissue.dev/) website. The projects that I am interseted in contributing to are as follows - 

   1) Joplin -

      Joplin is a free, open source note taking and to-do application, which can handle a large number of notes organised into notebooks. The tech stack used for development consist of Typescript, electronm, nodejs, javascript and other backend languages.
      The repository can be found [here](https://github.com/laurent22/joplin/tree/dev). It has some good amount of issues listed that I understand. Below is the completed checklist for this repository -
...
The guidelines describes the importance of being respectful and have a friendly nature towards other members. There is explanation of number of ways in which a user can contribute to the projects and proper way to do that. Further the [code of conduct](https://github.com/OpenBeta/open-tacos/blob/develop/CODE_OF_CONDUCT.md) explains the consequences of violating contributing guidlines of the project. There are no hard rules about contributing in this project but they expect good written explanation of the work done and corresponding supporting examples if needed. 

There is Discord chat server available as well which is very friendly and support every user in their ongoing development and any kind of questions they have.
